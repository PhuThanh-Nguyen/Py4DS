...
def main():
    ...
    accuracy = rfModel(X_train_RobustScaler, X_test_RobustScaler, y_train, y_test)
    ...
    accuracy = rfModel(X_train_NormalizeScaler, X_test_NormalizeScaler, y_train, y_test)
